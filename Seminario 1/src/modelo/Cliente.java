...
public class Cliente {
	...
	private List<ServicioCliente> serviciosContratados;
	@ManyToMany
	@JoinColumn(name = "idCliente")
	...
	public Cliente() {
		serviciosContratados = new ArrayList<ServicioCliente>();
	...
	public List<ServicioCliente> getServiciosContratados() {
		return serviciosContratados;
	}

	public void setServiciosContratados(
			List<ServicioCliente> serviciosContratados) {
		this.serviciosContratados = serviciosContratados;
	}
