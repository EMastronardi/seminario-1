...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	if(request.getAttribute("idPlan") == null ){
		String redirectURL = "ListaPlanes.jsp"; 
...
<html lang="en">
  <head>
    ...
    <title>La Cocina de Silvia / Visualizaci&oacute;n Plan</title>
    ...
    <div id="wrap">
      ...
      <div class="container">
      	 <ol class="breadcrumb">
				...
				<li><a href="ListaPlanes.jsp">Listado de Planes</a></li>
				<li class="active">Vista Plan</li>
			</ol>

			<div class="page-header">
				<h1>Visualizaci&oacute;n Plan  <span class="label label-default">Nro. <% out.print(plan.getIdPlan()); %></span></h1>
			</div>
