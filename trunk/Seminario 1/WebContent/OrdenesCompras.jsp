...
<html lang="en">
  <head>
    ...
    <title>La Cocina de Silvia / Ordenes de Compra</title>
...
<!-- Wrap all page content here -->
    <div id="wrap">
      ...
      <div class="container">
		  ...
		  <li class="active">OrdenesDeCompra</li>
		</ol>
        ...
        <p class="lead">
		   <div class="panel panel-default">
            	...
            	<div class="row">
            		<div class="col-lg-6">
						<button type="button" id="newIngrediente" class="btn btn-default btn-sm">
							<span class="glyphicon glyphicon-star"></span> Generar Orden de Compra
						</button>
						<button type="button" id="updateCliente"
							class="btn btn-default btn-sm">
							<span class="glyphicon glyphicon-pencil"></span> Ver Orden de Compra
						</button>
            	 	...
            	 	<div class="col-lg-6">
		            	<form method="post"  action='OrdenesDeCompraServlet?action=search' id="theform">
		            	<div class="row">
						  <div class="col-lg-8">
            ...
            <table class="table">
			  ...
			  <tbody>
			 <% // TODO Aca va la iteracion por los elementos de la orden de compra 
