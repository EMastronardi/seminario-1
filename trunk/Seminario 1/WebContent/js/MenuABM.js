...
function createMenu(){
	...
	bootbox
	.dialog({
		message :  "<label>Ensalada </label> " 
				+ "<br/>"
				+ "<div class=\"input-group\"><input type=\"text\" class=\"form-control\" id=\"searchInput\" name=\"valor\" value=\"\"><span class=\"input-group-btn\"><button class=\"btn btn-default\">Buscar Ensalada</button></span></div>"
				+ "<br/>"
				+ "<label>Plato Principal </label>"
				+ "<br/>"
				+ "<div class=\"input-group\"><input type=\"text\" class=\"form-control\" id=\"searchInput\" name=\"valor\" value=\"\"><span class=\"input-group-btn\"><button class=\"btn btn-default\">Buscar Principal</button></span></div>"
				+ "<br/>"
				+ "<label>Postre </label>"
				+ "<br/>"
				+ "<div class=\"input-group\"><input type=\"text\" class=\"form-control\" id=\"valorinput\" name=\"valor\" value=\"\"><span class=\"input-group-btn\"><button class=\"btn btn-default\">Buscar Postre</button></span></div>"
				+ "<br/>"
...
function showOpenDetialsIngrediente(){
	...
	.dialog({
		message : "<label>Ensalada </label> " 
				+ "<br/>"
				+ "<div class=\"input-group\"><input type=\"text\" class=\"form-control\" id=\"searchInput\" name=\"valor\" value=\""+menuEnsalada+"\" disabled><span class=\"input-group-btn\"><button class=\"btn btn-default\"  value=\"\">Buscar Ensalada</button></span></div>"
				+ "<br/>"
				+ "<label>Plato Principal </label>"
				+ "<br/>"
				+ "<div class=\"input-group\"><input type=\"text\" class=\"form-control\" id=\"searchInput\" name=\"valor\" value=\""+menuPltoPrincipal+"\" disabled><span class=\"input-group-btn\"><button class=\"btn btn-default\" >Buscar Principal</button></span></div>"
				+ "<br/>"
				+ "<label>Postre </label>"
				+ "<br/>"
				+ "<div class=\"input-group\"><input type=\"text\" class=\"form-control\" id=\"valorinput\" name=\"valor\" value=\""+menuPostre+"\" disabled><span class=\"input-group-btn\" ><button class=\"btn btn-default\" >Buscar Postre</button></span></div>"
				+ "<br/>"
...
function showOpenEditMenu(){
	...
	.dialog({
		message : "<label>Ensalada </label> " 
				+ "<br/>"
				+ "<div class=\"input-group\"><input type=\"text\" class=\"form-control\" id=\"searchInput\" name=\"valor\" value=\""+menuEnsalada+"\"><span class=\"input-group-btn\"><button class=\"btn btn-default\"  value=\"\">Buscar Ensalada</button></span></div>"
				+ "<br/>"
				+ "<label>Plato Principal </label>"
				+ "<br/>"
				+ "<div class=\"input-group\"><input type=\"text\" class=\"form-control\" id=\"searchInput\" name=\"valor\" value=\""+menuPltoPrincipal+"\"><span class=\"input-group-btn\"><button class=\"btn btn-default\" >Buscar Principal</button></span></div>"
				+ "<br/>"
				+ "<label>Postre </label>"
				+ "<br/>"
				+ "<div class=\"input-group\"><input type=\"text\" class=\"form-control\" id=\"valorinput\" name=\"valor\" value=\""+menuPostre+"\"><span class=\"input-group-btn\"><button class=\"btn btn-default\" >Buscar Postre</button></span></div>"
				+ "<br/>"
				+ "<label>Tag</label><select name=\"tag\">"+options+"</select>"
				+ "<br/>"
